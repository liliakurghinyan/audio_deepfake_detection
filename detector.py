...
class AudioDeepfakeDetector:
    def __init__(self, model_path="model.pt", sr=16000, n_mels=80):
        ...
        # Load threshold selected from validation
        self.threshold = 0.5
        ...
        print("Loaded decision threshold:", self.threshold)
    ...
    def _load_audio_from_path(self, path: str) -> torch.Tensor:
        ...
        # IMPORTANT: same length as training dataset
        max_len = self.sr * 4
    ...
    def predict_from_upload(self, audio_bytes: bytes, filename: str):
        ...
        try:
            ...
            print("DEBUG prob_fake:", prob_fake)
            print("DEBUG prob_real:", prob_real)
